                        ...
                        <div class="col-lg-3 col-sm-6 shops-griss">
                            <div class="box-shop-wrd">
                                ...
                                <div class="cw-b-rwap">
                                    ...
                                    <div class="rf-nowsecname">Logo Design</div>
                                    <div class="mt-42">
                                    ...
                                    <div class="d-flex align-items-center mt-10">
                                        <button class="c-btn-c pt-7 pb-7">Edit Details</button>
                                    </div>
                                </div>
                            </div>
                            <div class="oline_atirlw mb-1">One Line Asset Title </div>
                        </div>
                <?php
                    }
                }
