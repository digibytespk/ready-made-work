...
<div class="container mt-50">
    <div class="clp-flex-a">
        <h1 class="cs-h1">Notifications</h1>
        <button class="c-btn-c mr-0">
            Mark all as Read
        </button>
    </div>
    <div class="notifi-xob">
        <ul>
            <li class="d-flex notfi-li-main">
                <div class="mr-10 imnode_nim"><img src="/assets/branding/window.png" /></div>
                <div class="pgram-notfi">Arados Markachanda <span>uploaded a new design asset in the </span>Branding<span> Category</span>.</div>
            </li>
            <li class="d-flex notfi-li-main">
                <div class="mr-10 imnode_nim"><img src="/assets/branding/motos.png" /></div>
                <div class="pgram-notfi">Arados Markachanda <span>uploaded a new design asset in the </span>Branding<span> Category</span>.</div>
            </li>
            <li class="d-flex notfi-li-main bb-none">
                <div class="mr-10 imnode_nim"><img src="/assets/branding/wix.png" /></div>
                <div class="pgram-notfi">Arados Markachanda <span>uploaded a new design asset in the </span>Branding<span> Category</span>.</div>
            </li>
        </ul>
    </div>
