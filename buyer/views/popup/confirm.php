<div class="popup-wrapper-center confirm_popup">
    <div class="popup-modal-center">
        <div class="popup-header">
            <div class="popup-heading">Offer Acceptance Confirmation </div>
            <div>
        ...
        <div class="popup-inner-body">
            <div class="notifib-xte">
                You are about to accept the offer of <b>$ 5,600.00</b> to start this project. Please confirm your action.
            </div>
            <div class="line-br-gya mt-30"></div>
            <div class=" pt-20 mt-10">
                <div class="ft-cclp-but text-right">
                    <button class="c-btn-c">Yes, Start Project</button>
...
<script>
    $(document).on("click", ".close-popup-mina", () => {
        $(".confirm_popup").removeClass("show");
    });
    $(document).on("click", ".show-con-popup", () => {
        $(".confirm_popup").addClass("show");
    });
</script>